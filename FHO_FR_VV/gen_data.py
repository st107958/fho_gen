...
n_points = 40
T_min, T_max = 1000, 16000  # Диапазон
...
df_long = pd.melt(
    df_k,
    id_vars=['Temperature'],
    value_vars=[f'j_{j}' for j in range(1, 3)],
...
df_long.to_csv('N2_long.csv', index=False)
...
# df_k.to_csv('N2_test.csv', index=False, header=False)
